...
public record OBCashAccount(
	...
	@JsonProperty("Identification") @JsonPropertyDescription("Identification assigned by an institution to identify an account") @Nullable String identification,
